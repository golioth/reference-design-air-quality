...
static enum golioth_rpc_status on_clean_pm_sensor(zcbor_state_t *request_params_array,
						  zcbor_state_t *response_detail_map,
						  void *callback_arg)
{
...
static enum golioth_rpc_status on_reset_pm_sensor(zcbor_state_t *request_params_array,
						  zcbor_state_t *response_detail_map,
						  void *callback_arg)
{
...
void app_rpc_register(struct golioth_client *client)
{
	...
	err = golioth_rpc_register(rpc, "clean_pm_sensor", on_clean_pm_sensor, NULL);
	rpc_log_if_register_failure(err);
